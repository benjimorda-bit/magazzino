...
# FIX 2: Percorso database risolto correttamente sia in sviluppo che da .exe
def _get_percorso_database() -> str:
    ...
    if getattr(sys, "frozen", False):
        # Siamo dentro un eseguibile PyInstaller
        base = os.path.dirname(sys.executable)
    else:
        # Sviluppo normale con Python
...
class GestoreDatabase:
    ...
    def _carica_database(self) -> pd.DataFrame:
        ...
        # FIX 1: Forza Nr come stringa per evitare mismatch di tipo
        # quando Excel rilegge codici numerici come int/float
    ...
    def elimina_tappeto(self, codice: str) -> bool:
        ...
        # FIX 1: confronto str-to-str garantito
...
class FrameCercaElenco(ctk.CTkFrame):
    ...
    def _elimina_selezionato(self):
        ...
        # Ottieni l'indice della riga in modo robusto
        try:
